report 50002 Invoice
{
    ...
    dataset
    {
        ...
        dataitem(SalesInvoiceHeader; 112)
        {
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                column(Salesperson_Phone_No_; Salesperson."Phone No.")
                {
                }
                dataitem(SalesInvoiceLine; 113)
                {
                    ...
                    dataitem(SalesShipmentBuffer; Integer)
                    {
                        DataItemTableView = SORTING (Number)
                                            WHERE (Number = FILTER (1 ..));
                    ...
                    dataitem(AsmInformation; Integer)
                    {
                        DataItemTableView = SORTING (Number)
                                            WHERE (Number = FILTER (1 ..));
                ...
                begin
                    ...
                    // DocMgt.SetHeaderCaption(t.x('Invoice') + CopyText, 1);
                    ...
                    // DocMgt.SetArrayData(Salesperson."Phone No.", 25);
    ...
    var
        ...
        tSalesShipmentBuffer: Record 7190 temporary;
        tPostedAsmLine: Record 911 temporary;
        tVATAmountLine: Record 290 temporary;
        tVATAmountLine2: Record 290 temporary;
        SalesInvLine: Record 113;
        tSalesInvLine: Record 113 temporary;
        ...
        tItemLedgEntry: Record 32 temporary;
        tVATClause: Record 560 temporary;
    ...
    procedure AddSalesShipmentBufferEntry(pSalesInvLine: Record "Sales Invoice Line")
    var
